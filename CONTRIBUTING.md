...
Feel free to ask your question about the project in the [issues section](https://github.com/wppconnect-team/wppconnect-extension/issues). It's also a great way to connect with other contributors.
...
3. After you submit your pull request, verify that all [status checks](https://github.com/wppconnect-team/wppconnect-extension/pulls) are passing
